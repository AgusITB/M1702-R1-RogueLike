    ...
    void CreateGrid()
    {
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            for (int y = 0; y < gridSizeY; y++)
            {
                ...
                bool walkable = (Physics2D.OverlapCircle(worldPoint, nodeRadius-0.2f, unwalkableMask) == null); // if no collider2D is returned by overlap circle, then this node is walkable
